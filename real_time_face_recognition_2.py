...
while True:
    ...
    if frame_counter % frame_interval == 0:
        # Resizing the current frame to make it smaller to increase processing speed-
        current_frame_small = cv2.resize(current_frame, (0, 0), fx=0.5, fy=0.5)
        
        faces_to_detect = face_recognition.face_locations(current_frame_small,number_of_times_to_upsample=2, model="hog")
